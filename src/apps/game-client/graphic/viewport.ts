...
import { providePrimaryUBO } from "./primary-ubo.ts";

export class Viewport {
  public readonly centerPoint = pos2D(0, 0);
  public readonly centerChunk = pos2D(0, 0);
  public readonly halfSize = pos2D(0, 0);
  public readonly size = pos2D(0, 0);
  public level = 0;
  public spaceId = 1;
  public readonly spaceRect = box2P(0, 0, 0, 0);
